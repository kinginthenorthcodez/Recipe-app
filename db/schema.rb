...
ActiveRecord::Schema[7.0].define(version: 2022_09_08_182839) do
  ...
  create_table "goodies", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_goodies_on_user_id"
  end
  ...
  create_table "recipes", force: :cascade do |t|
    t.string "name"
    t.decimal "preparation_time", precision: 10, scale: 2, default: "0.0"
    t.decimal "cooking_time", precision: 10, scale: 2, default: "0.0"
